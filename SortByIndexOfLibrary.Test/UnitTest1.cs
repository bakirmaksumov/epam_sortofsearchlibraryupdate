...
namespace SortByIndexOfLibrary.Test
{
    [TestFixture]
    public class Tests
    {
        ...
        {
            Assert.That(() => SortIndexLibrary.Sort(null), Throws.InstanceOf<ArgumentNullException>());
        }
        [Test]
        ...
        public void IndexOf_Products_ReturnsTwo()
        {
            ...
            int index = SortIndexLibrary.IndexOf(products, product => product.Equals(productToFind));
        ...
        public void IndexOf_NullProducts_ThrowsArgumentNullException()
        {
            ...
            {
                var productToFind = new Product("Product 3", 30.0d);
                int index = SortIndexLibrary.IndexOf(null, product => product.Equals(productToFind));
        ...
        public void IndexOf_NullPredicate_ThrowsArgumentNullException()
        {
            Assert.That(() =>
            {
                ...
                int index = SortIndexLibrary.IndexOf(products, null);
            }, Throws.InstanceOf<ArgumentNullException>());
        }
